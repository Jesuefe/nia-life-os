...
function MemoryView({mem,save,onOpenWA}) {
  ...
  const clearAll=()=>{ if(confirm("Clear all memory? Cannot be undone.")) save({goals:[],habits:[],reminders:[],notes:[],userName:null,age:null,marital:null,occupation:null,habitLogs:{},onboarded:false,whatsappNumber:null,whatsappLogs:[]}); };
  ...
  return (
    <div style={{maxWidth:660,margin:"0 auto",width:"100%",padding:"24px 16px"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
        ...
        <div style={{display:"flex",gap:8}}><Btn variant="ghost" onClick={exp} size="sm" icon="download">Export</Btn><Btn variant="danger" onClick={clearAll} size="sm" icon="trash">Clear</Btn></div>
      </div>
